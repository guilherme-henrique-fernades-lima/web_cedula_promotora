...
import { convenioSchema } from "@/schemas/picklists/convenioSchema";
...
export default function ConfiguracoesLojas() {
  ...
  const {
    ...
    mode: "onChange",
    resolver: yupResolver(convenioSchema),
  });
  ...
  async function save() {
    try {
      ...
      const response = await fetch("/api/configuracoes/picklists/convenios", {
        method: "POST",
        headers: {
  ...
  async function update() {
    try {
      ...
      const response = await fetch(
        `/api/configuracoes/picklists/convenios/?id=${id}/`,
        {
          method: "PUT",
          headers: {
            Authorization: session?.user?.token,
  ...
  return (
    <ContentWrapper title="Cadastro e manutenção de convênios">
