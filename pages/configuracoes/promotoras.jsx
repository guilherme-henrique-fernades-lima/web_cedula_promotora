...
export default function ConfiguracoesLojas() {
  ...
  async function save() {
    try {
      ...
      const response = await fetch("/api/configuracoes/picklists/promotoras", {
        method: "POST",
        headers: {
  ...
  async function update() {
    try {
      ...
      const response = await fetch(
        `/api/configuracoes/picklists/promotoras/?id=${id}/`,
        {
          method: "PUT",
          headers: {
            Authorization: session?.user?.token,
  ...
  return (
    <ContentWrapper title="Cadastro e manutenção de promotoras">
